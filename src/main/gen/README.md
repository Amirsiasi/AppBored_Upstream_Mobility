...
Bored API
- API version: 1.0.0
  - Build date: 2024-02-18T15:04:28.768631200+01:00[Europe/Vienna]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**getRandomActivity**](docs/DefaultApi.md#getRandomActivity) | **GET** /activity | Ruft eine zufällige Aktivität ab
